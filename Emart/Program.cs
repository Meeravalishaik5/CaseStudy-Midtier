	...
	class Program
	{
		static void Main(string[] args)
		{
			...
			for (; ; )
			{
				...
				ViewandSearchBO vb;
				IViewandSearchBO ivb;
				vb = new BuyerandSeller();
				ivb = new BuyerandSeller();
										...
										while (true)
										{
											...
											switch (se)
											{
												...
												case 2:
													...
													int iid4 = int.Parse(Console.ReadLine());
													ib1.BuyItem(iid4);
													break;
												case 3:
													...
													ivb.SearchItem(iid1);
													break;
												case 0 :Console.WriteLine("Back to previous page...");
													goto sample3;
											}
										sample3: break;	
										}
										...
										while (true)
										{
											...
											switch (bch)
											{
												...
												case 2:
													vb.viewItems();
													break;
												case 3 :Console.WriteLine("Enter Item Id..");
